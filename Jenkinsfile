...
stage ('Build') 
{
    steps
    {
       sh "cd /home/ubuntu/workspace/customerservice-pipeline/customer-service ; mvn clean install " 
        sh "cd /home/ubuntu/workspace/accountservice-pipeline/account-service ; mvn clean install " 
...
stage ('dockerimageBuild')
    ...
    steps
    {
        ...
        sh "cd /home/ubuntu/workspace/accountservice-pipeline/account-service; sudo docker build -t customer-service . " 
     ...
     stage ('dockerimagepush ') 
{
    steps
    {
       sh "cd /home/ubuntu/workspace/customerservice-pipeline/customer-service ; sudo  docker login -u nagurbabu -p @Nagur336 "
        ...
        sh "cd /home/ubuntu/workspace/accountservice-pipeline/account-service ; sudo  docker login -u nagurbabu -p @Nagur336 "
        sh "cd /home/ubuntu/workspace/accountservice-pipeline/account-service ; sudo docker tag account-service nagurbabu/account-service "
        sh "cd /home/ubuntu/workspace/accountservice-pipeline/account-service ; sudo docker push nagurbabu/account-service  "
